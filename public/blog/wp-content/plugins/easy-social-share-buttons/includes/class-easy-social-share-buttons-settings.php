...
class Easy_Social_Share_Buttons_Settings {
	...
	public function settings_page () {
		...
		<h3><?php echo __( 'Facebook App Id', 'easy-social-share-buttons' ); ?></h3>
		...
		<p><?php echo __( 'See documentation on using filters:'); ?> <a href="https://developer.wordpress.org/reference/functions/add_filter/" target="_blank">Wordpress add_filter code reference</a></p>
		<dl>
